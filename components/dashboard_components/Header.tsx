...
export function Header({ showGreeting = true }: HeaderProps) {
  ...
  return (
    <>
      ...
      <div className="sticky top-0 z-40 w-full px-4 pt-4 sm:px-6 lg:px-8 bg-blue-50/80 backdrop-blur-md pb-2 transition-all">
        {/* Main Header */}
        <header
          className="
            relative
      ...
      {/* GREETING (Flows normally below sticky header) */}
      {showGreeting && (
        <div className="flex items-center justify-between px-7 pt-4 pb-2 sm:px-9">
          <h1
            className="
              flex
              items-center
