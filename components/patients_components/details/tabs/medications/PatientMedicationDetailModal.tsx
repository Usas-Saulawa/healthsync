          ...
          >
            ...
            <div className="px-[42px] mt-2">
              <button
                ...
                className="w-[529px] h-[50px] bg-app-bg text-slate-900 font-semibold text-sm rounded-[6px] px-6 py-3 flex items-center justify-center gap-2.5 transition-colors cursor-pointer shadow-2xs"
              >
            ...
            <div className="px-[45px] mt-6">
              <div className="w-[526px] flex items-center justify-between text-xs font-semibold text-slate-800">
                  ...
                  {medications.map((med) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="w-[70px] text-xs font-medium text-slate-700">
                          {med.route}
                        </div>
                        ...
                        <div className="w-[70px] text-xs font-medium text-slate-700 text-right">
                          {med.duration}
                        </div>
                      </div>
                    );
