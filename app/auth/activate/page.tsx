    ...
    <div className="flex min-h-screen w-full bg-blue-50 font-sans">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-linear-to-br from-primary-700 via-primary-600 to-primary-900 p-12 flex-col justify-between text-white relative overflow-hidden">
        ...
        <div className="flex items-center gap-3 z-10">
          <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-(--card)/20 backdrop-blur-md">
        ...
        <div className="z-10 max-w-lg space-y-6 my-auto">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-(--card)/10 backdrop-blur-md text-xs font-medium text-primary-100 border border-white/10">
          ...
          <div className="grid grid-cols-2 gap-4 pt-4">
            <div className="flex items-start gap-3">
              <div className="p-2 rounded-lg bg-(--card)/10 text-primary-200 mt-1">
      ...
      <div className="flex flex-1 items-center justify-center p-6 sm:p-12">
        <div className="w-full max-w-xl rounded-3xl bg-(--card) p-8 sm:p-12 shadow-xl border border-gray-100">
            ...
            <div>
              <div className="relative">
                <input
                  ...
                  {...register("uniqueId")}
                  className="w-full rounded-xl border border-gray-200 bg-gray-50/50 py-3.5 px-4 text-gray-900 placeholder-gray-400 focus:border-blue-600 focus:bg-(--card) focus:outline-none focus:ring-1 focus:ring-blue-600 transition-all text-sm"
                />
              </div>
            </div>
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-(--card) px-4 text-gray-400 font-medium">
                or
              </span>
            </div>
          </div>
