...
export default function MedicalHistoryPage({
  ...
  return (
    <div className="w-full min-h-screen bg-(--background) pb-12 pt-6 space-y-6">
      <Header />
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <button
              type="button"
              onClick={() => router.back()}
              className="flex h-10 w-10 items-center justify-center rounded-full bg-(--card) text-[#0f172a] shadow-xs  hover:bg-slate-50 transition-colors cursor-pointer"
              aria-label="Go back"
            >
